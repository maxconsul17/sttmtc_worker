...
require_once('system/libraries/excel/PEAR.php');

require_once('system/libraries/excel/ole/OLE.php');
...
class OLE_PPS extends PEAR
{
    ...
    */
    function OLE_PPS2($No, $name, $type, $prev, $next, $dir, $time_1st, $time_2nd, $data, $children)
    {
        $this->No      = $No;
        $this->Name    = $name;
        $this->Type    = $type;
