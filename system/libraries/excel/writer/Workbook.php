...
require_once 'system/libraries/excel/writer/Format.php';
require_once 'system/libraries/excel/writer/BIFFwriter.php';
require_once 'system/libraries/excel/writer/Worksheet.php';
require_once 'system/libraries/excel/writer/Parser.php';
require_once 'system/libraries/excel/ole/pps/Root.php';
require_once 'system/libraries/excel/ole/pps/File.php';
...
class Spreadsheet_Excel_Writer_Workbook extends Spreadsheet_Excel_Writer_BIFFwriter
{
    ...
    * @access public
    */
    function Spreadsheet_Excel_Writer_Workbooks($filename)
    {
        // It needs to call its parent's constructor explicitly
        $this->Spreadsheet_Excel_Writer_BIFFwriters();
