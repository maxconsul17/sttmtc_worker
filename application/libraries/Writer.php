...
require_once 'application/libraries/excel/PEAR.php';
require_once 'application/libraries/excel/writer/Workbook.php';
...
class Spreadsheet_Excel_Writer extends Spreadsheet_Excel_Writer_Workbook
{
    ...
    */
    function __construct($filename = '')
    {
        ...
        $this->Spreadsheet_Excel_Writer_Workbooks($filename);
    }
